...
class Frame(Base):
    ...
    client_adress_postcode = Column(String(250))
    ...
    editor_adress_postcode = Column(String(250))
    editor_adress_country = Column(String(250))
    editor_phone = Column(String(250))
...
class Report(Base):
    ...
    report_visitDate = Column(String(250))
    report_redactionDate = Column(String(250))
    report_picture = Column(String(250))
    report_pictureOrientation = Column(String(250))
    editor_lastname = Column(String(250))
    editor_firstname = Column(String(250))
    editor_full_adress = Column(String(250))
    editor_adress_number = Column(String(250))
